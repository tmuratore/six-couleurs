...
/**
 * JPanel that is used to customise (select the Tile's colors) a grid before playing
 */
public class CustomGrid extends JPanel {
    ...
    /**
     * Generates a JButton with the correct color and register's it to the controller
     *
     * @param color the color of JButton
     * @param i     Abscissa of the button
     * @param j     Ordinate of the button
     * @param small if the button is in the "small" size
     * @return the colored JButton
     */
